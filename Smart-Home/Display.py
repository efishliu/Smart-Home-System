...
def windows():
    ...
    sleep_flaglabel_name=Label(fm_flag_set,text='睡眠模式开关',font=('宋体', 15))
    sleep_flaglabel_name.pack(side=LEFT,pady=10)
    sleep_flaglabel_val=Label(fm_flag_set,textvariable=sleep_flag,font=('宋体', 15))
    sleep_flaglabel_val.pack(side=LEFT,padx=30)

    set_templabel_name=Label(fm_flag_set,text='设定温度',font=('宋体', 15))
